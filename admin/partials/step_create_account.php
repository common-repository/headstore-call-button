...
<div id="headstore-first-account">
    <h2><?php  _e( 'Connect to PAYCALL', $this->plugin_name); ?></h2>
    ...
    <form id="form-headstore-first-account" method="POST" >
		...
		<input type="hidden" name="form-submit" value="submit">
	       ...
	       <h3><?php _e('Create your PAYCALL account:',$this->plugin_name); ?></h3>
		   <?php _e("If you don't have a PAYCALL account, please create a new account.",$this->plugin_name); ?><br>
		   <!-- <?php _e("You will be redirected to the PAYCALL website in a new page.",$this->plugin_name); ?><br> -->
		   <?php _e("If you need help, please read the",$this->plugin_name); ?> <a href="https://wordpress.org/plugins/headstore-call-button/faq/"  class="hs-link" target="_blank">  <?php _e( 'FAQ', $this->plugin_name);?></a>  <?php _e("regrarding the question 'How can I create a PAYCALL account?' and follow these steps.",$this->plugin_name); ?> <br>
           ...
           <p> 
			<h3><?php _e('Connect your PAYCALL account:',$this->plugin_name); ?></h3>
