...
if ( ! defined( 'ABSPATH' ) ) {
 ...
 $message = __( "You have successfully activated the 'PAYCALL Button' plugin. Just follow the instructions to add your 'PAYCALL button' to your website.", $this->plugin_name);
